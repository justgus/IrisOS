...
pkgdatadir = $(datadir)/referee
pkgincludedir = $(includedir)/referee
pkglibdir = $(libdir)/referee
pkglibexecdir = $(libexecdir)/referee
...
PACKAGE_STRING = referee 0.1.0
PACKAGE_TARNAME = referee
PACKAGE_URL = 
