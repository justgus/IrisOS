...
| SP-003 | Queryable processor and memory inventory | Active |
...
| T-0179 | Registered Processor Architecture Model | SP-003 | Active |
| T-0180 | Registered Memory Topology Model | SP-003 | Active |
| T-0181 | In-Memory Machine Descriptors and Queries | SP-003 | Active |
...
*Last Updated: 2026-08-21 (SP-003 planning approved and activated)*
