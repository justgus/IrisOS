...
| SP-003 | Queryable processor and memory inventory | Review |
...
| T-0179 | Registered Processor Architecture Model | SP-003 | Implemented - Not Verified |
| T-0180 | Registered Memory Topology Model | SP-003 | Implemented - Not Verified |
| T-0181 | In-Memory Machine Descriptors and Queries | SP-003 | Implemented - Not Verified |
