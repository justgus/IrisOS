...
| ---- | ----- | -----: | ------ |
| T-0182 | Capability-Bearing Machine Handles | 5 | Verified |
| T-0183 | Deterministic Machine Lease Lifecycle | 8 | Verified |
...
**Completed:**
- Added typed, capability-bearing handles for memory blocks, devices, and memory-mapped IO regions.
- Added deterministic owner release and supervisor revocation by lease, owner, or capability context.
- Kept authority separate from immutable Machine descriptors and introduced no real hardware access.

**Returned to Backlog:**
- None.

**What went well:**
- Persisted capability contexts provided a clear trust boundary for handle and lease construction.

**What to improve:**
- Split executable Comms work at the transport/session and protocol/compatibility dependency boundary.

**Carry-forward notes:**
- SP-005 consumes Machine handles and leases through a bounded loopback transport and session model.

*Last Updated: 2026-08-24 (SP-004 verified and closed)*
