...
Legacy-ID: DR-0001
GitHub-Issue: #116
Source-Path: docs/DR/DR-0001-Conch-Compare-Alias-Resolution.md
---

# I-0001 — Conch Compare Alias Resolution
...
This Airframe Issue was generated from the legacy DR record during the local documentation migration. The target status represents the approved source documentation state and is not a new verification action.

## Preserved Legacy DR Content
