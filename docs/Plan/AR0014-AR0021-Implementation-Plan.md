...
- ER-0034 Referee Storage Layout Implementation (Proposed)
- ER-0035 Referee Recovery and Rebuild Workflows (Proposed)
- ER-0036 Definition Versioning and Migration Hooks (Proposed)
...
- ER-0037 Refract-Native Schema Registry Migration (Proposed)
- ER-0038 Structured Types: Struct/Packet/Enum (Proposed)
- ER-0039 Structured Arrays and Collection Integration (Proposed)
...
- ER-0040 Generic Type System Core (Proposed)
- ER-0041 Scoped Type Registry (Proposed)
...
- ER-0042 Core Operations Metadata and Bindings (Proposed)
...
- ER-0043 CEO Runtime Hardening (Proposed)
- ER-0044 Capability Hooks and Policy Plumbing (Proposed)
- ER-0045 Kernel I/O Primitives Integration (Proposed)
...
- ER-0046 v1 Kernel Demo Integration and Roadmap (Proposed)
